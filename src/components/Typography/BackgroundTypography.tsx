...
export const BackgroundTypography = (props: BackgroundTypographyProps) => {
    ...
    return (
        <div className={clsx(className, classes.root)}>
            <Typography variant={variant} className={classes.text}>{children}</Typography>
            <Typography noWrap className={classes.backgroundText} variant={variant} color='backgroundText'>{children}</Typography>
        </div>
    )
}
