                ...
                <Fade triggerOnce direction='up'>
                    <div className={classes.content}>
                        ...
                        <Typography className={classes.text} color='secondary'>
                            Ich heiße Jan Höck, wurde am 17.01.1996 geboren und komme aus der Nähe von Köln. Meine Leidenschaft ist die
                            ...
                            <br />
                            Ich war schon immer an Technik interessiert. In meinem Kinderzimmer habe ich das erste Mal von Java gehört und fand es so
                            interessant, dass ich mir es kurzerhand selber beigebracht habe. Während meiner Ausbildung bin ich dann mit ReactJS in
                            Berührung gekommen. Von Backend zu Frontend! Nun spezialisiere ich mich seit guten 5 Jahren auf dieses Framework. Mein
