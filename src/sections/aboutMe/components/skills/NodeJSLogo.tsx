...
export const NodeJSLogo = (props: HTMLAttributes<SVGElement>) => (
    <svg enableBackground='new 0 0 2249 2249' viewBox='0 0 2249 2249' xmlns='http://www.w3.org/2000/svg' width='256px' height='256px' {...props}>
        <path
